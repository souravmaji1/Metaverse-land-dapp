		...
		<div>
			...
			{landId && (
				<div className="info">
					<h1>MAP v1.2</h1>
					<br></br>
					<h3>GENERAL<span Id="sourav">MY PROFILE</span><span Id="sm">MY LAND</span></h3>
					<br></br>
					
					<h3><span Id="singh">RESET ZOOM</span><span Id="ss">CLEAR HIGHLIGHTS</span></h3>
					<br></br>
					<h3>GO TO COORDINATE</h3>
					<span Id="singhs">0</span><span Id="sss">0</span>
					<h3 Id="dekh">GO TO COORDINATE</h3>
					<br></br>
					<h3>CURSOR COORDINATES</h3>
					<img src="./one.png" alt="./one.png" width="400px" style={{borderRadius: "20px"}}></img>
